...
/*
    Dodati metodu obrisiOdAdoB() koja brise sve elemente koji se nalaze izmedju ova dva broja u listi,
    i ne smije se koristiti metoda obrisi().
*/
